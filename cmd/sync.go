...
var syncCmd = &cobra.Command{
	...
	Long: heredoc.Doc(`
		...
		The command scripts, located by default in the 'out' directory (which contain Kusto Management Commands) are loaded and executed against the target Kusto database.
...
func init() {
	...
	syncCmd.Flags().StringVar(&clientId, "client-secret", "", "The secret of the application to authenticate with")
